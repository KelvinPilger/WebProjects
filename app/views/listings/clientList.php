<div class="tableContainer">
	<div id="headerButtons">
		<strong>
			<a href="/client/create" class="btnIncluir" direction="right" id="btnIncluir">
				Cadastrar
			</a>
		</strong>
	</div>
	<table class="myTable">
		...
		<form id="filterForm" method="get" action="client/index">
			<input
				type="hidden"
				name="page"
				id="pageInput"
				...
				<?php if (!empty($clients)): ?>
					<?php foreach ($clients as $c): ?>
						<tr id="row-<?= $c['id'] ?>">
							...
							<td id="actionTd">
								<a id="btnEdit" href="/client/edit/<?= htmlspecialchars($c['id'], ENT_QUOTES, 'UTF-8') ?>" data-direction="right">
