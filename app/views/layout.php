...
<body>
  ...
  <nav id="sidebarNav">
    <div id="accessButtons">
      ...
      <div class="dropdown">
        <button id="btnOs" class="navButtons dropdown-toggle">
          ...
          <span class="btn-text">OS</span>
          <span class="arrow" id="arrowToggle">&#x25BC;</span>
        </button>
        <div class="dropdown-menu hidden">
          <a class="dropButtons" href="<?= BASE_URL ?>/serviceorder/index">
            Ordens de Serviço
          </a>
          <a class="dropButtons" href="<?= BASE_URL ?>/object/index">
            Objetos
          </a>
          <a class="dropButtons" href="<?= BASE_URL ?>/situation/index">Situações</a>
        </div>
      </div>
    </div>
  </nav>
  ...
  <script>
    ...
    function toggleDropdown() {
      const dropdownBtn = document.getElementById('btnOs');
